...
var html = ["div","anchor","iframes","filepaths","blocks","editors","attributes","children","headings","hyperlinks"];
...
var python = ["yield","user-interface","whileloop","variables","tuple","statement","strings","str","slice","setuptools","zenofpython","try"];
...
,"anchor The HTML code for creating a link to another page or to a particular section within a page. It is also commonly called an h-ref.","Responsive design is an approach to web page creation that makes use of flexible layouts, flexible images and cascading style sheet media queries. The goal ofresponsive design is to build web pages that detect the visitor's screen size and orientation and change the layout accordingly.","layout,In word processing and desktop publishing, layout refers to the arrangement of text and graphics. The layout of a document can determine which points are emphasized, and whether the document is aesthetically pleasing."
